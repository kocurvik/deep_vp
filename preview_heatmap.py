...
def preview():
    ...
    # cap = cv2.VideoCapture('D:/Skola/PhD/data/2016-ITS-BrnoCompSpeed/dataset/session5_left/video.avi')
    cap = cv2.VideoCapture('D:/Skola/PhD/data/BrnoCarPark/videos/video.mp4')
    # mask = cv2.imread('D:/Skola/PhD/data/2016-ITS-BrnoCompSpeed/dataset/session5_left/video_mask.png', 0)
    ...
    while ret:
        ...
        for box in boxes:
            ...
            for j, scale in enumerate(scales):
                ...
                vp1_box, vp1_dist = process_heatmap_old(heatmap_vp1, scale)
                vp2_box, vp2_dist = process_heatmap_old(heatmap_vp2, scale)
